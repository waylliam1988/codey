...
class ProviderSelectorUiTests(unittest.TestCase):
    ...
    def test_research_context_is_explicit_and_user_facing(self) -> None:
        ...
        self.assertIn("Research restored:", RESEARCH_RUNS_JS)
        self.assertIn("$('research-restore').disabled = !current || !current.restoreable;", RESEARCH_RUNS_JS)
        ...
        self.assertIn("invalidateResearchNoteCache(noteIdsForResearchRun(run))", RESEARCH_RUNS_JS)
