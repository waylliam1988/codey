...
2026-09-05 claim-to-evidence binding patch:
`codey.research.object_model` now keeps each `EvidenceItem.claim` as an internal
non-serialized matcher field and uses it, plus the bounded excerpt, when binding
