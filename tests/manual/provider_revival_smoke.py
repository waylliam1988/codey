...
def run_provider_smoke(
    ...
    *,
    ...
    from codey.providers import registry as _provider_registry

    original_borrow = _provider_registry.borrow_open_provider
    ...
    try:
        ...
        with (
            ...
            mock.patch.object(
                _provider_registry, "borrow_open_provider", side_effect=tracked_borrow
            ),
            mock.patch.object(
