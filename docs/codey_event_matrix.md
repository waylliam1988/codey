...
| runtime_operation.state | codey.runtime.effects | task_run, run_details | runtime_operations | runtime_session_log | false | false | false | false | phase, provider id, turn counts, proof refs/status, repair round count, repair-context digest, and bounded blocked reason only; prompts, replies, stdout, diffs, and source bodies are excluded |
