...
0.4.22：Qwen coding/completion、Research、Ghost core smoke 已收口；产出最终 0.4 report
```
...
下一步产出 0.4.22 final stabilization report，再决定是否进入 0.5 或补第三 provider cross-check
```
