...
0.4.22：Qwen coding/completion core 与 Research core smoke 已收口；继续 Qwen Ghost core 后产出最终 0.4 report
```
...
下一步进入 Qwen Ghost core；不要把 Ghost 结论混进 coding/research 证据
```
