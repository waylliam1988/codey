...
def builtin_capability_registry() -> CapabilityRegistry:
    return CapabilityRegistry((
        CapabilitySpec(
            ...
            owner_module="codey.agents.runner",
        ...
        CapabilitySpec(
            ...
            owner_module="codey.workspace.changes",
        ),
        CapabilitySpec(
            id="chat_runner",
            ...
            model_visible=True,
            owner_module="codey.app.task_runner",
            trace_sections=("prompt_sections",),
        ...
        CapabilitySpec(
            ...
            owner_module="codey.completion.contract",
        ...
        CapabilitySpec(
            ...
            permission_profiles=("coding_writer",),
            owner_module="codey.completion.repair_context",
            projection_audience=("model_visible", "behavior_input"),
        ...
        CapabilitySpec(
            ...
            consumes=("prompt_envelope", "run_trace"),
            model_visible=True,
            owner_module="codey.agents.consensus",
            trace_sections=("prompt_sections",),
            projection_audience=("model_visible",),
            release_gate="live_smoke",
        ),
        CapabilitySpec(
            ...
            consumes=("prompt_envelope", "run_trace"),
            model_visible=True,
            owner_module="codey.agents.handoff",
            trace_sections=("prompt_sections",),
            projection_audience=("model_visible",),
            release_gate="live_smoke",
        ),
        CapabilitySpec(
            ...
            consumes=("prompt_envelope", "run_trace"),
            trace_sections=("prompt_sections",),
            owner_module="codey.workspace.context_epoch",
        ...
        CapabilitySpec(
            ...
            owner_module="codey.policies.permissions",
        ),
        CapabilitySpec(
            id="policy_guard",
            provides=("permission_profile_boundary", "action_policy_boundary"),
            owner_module="codey.policies.action",
        ...
        CapabilitySpec(
            ...
            owner_module="codey.runtime.prompt_envelope",
        ),
        CapabilitySpec(
            id="provider_capability_registry",
            provides=("provider_fit_hints", "fallback_ordering_hints"),
            owner_module="codey.providers.capabilities",
        ),
        CapabilitySpec(
            id="provider_factory",
        ...
        CapabilitySpec(
            id="research_topic_continuity",
            provides=("research_topic_continuity_projection", "topic_candidate_projection"),
        ...
        CapabilitySpec(
            ...
            fail_mode="fail_closed",
            release_gate="unit_tests",
            owner_module="codey.runs.ledger",
        ),
        CapabilitySpec(
            id="run_details",
            provides=("run_details_projection",),
            consumes=("run_ledger", "run_operation", "run_trace"),
            ui_surface=("chat_stream",),
            owner_module="codey.runs.details",
            projection_audience=("ui_visible",),
            canonical_inputs=("run_ledger", "run_operation", "run_trace"),
            fail_mode="fail_open",
            release_gate="unit_tests",
        ),
        CapabilitySpec(
            id="run_operation",
            provides=("run_operation_state",),
            durable_state=("run_operations",),
            owner_module="codey.run_operation",
            fail_mode="fail_open",
            release_gate="unit_tests",
        ),
        CapabilitySpec(
        ...
        CapabilitySpec(
            ...
            owner_module="codey.toolchain.runtime",
        ),
    ))
