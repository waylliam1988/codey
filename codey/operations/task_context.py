...
Orchestration assembly (knowledge + verification + checkpoint); lives in
operations so workspace/ stays scan/map/paths/revision/facts only."""
...
class ProjectTaskContextBuilder:
    ...
    def _initialize_checkpoint(
        ...
        *,
        ...
        notice = _corrupt_backup_notice(corrupt_backup)
        ...
        try:
            ...
            # A fresh start can fail after a corrupt backup was already
            # taken: keep the corruption notice even with no new item.
            return CheckpointContext(
