...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "DEFAULT_PROVIDER_ID": ("codey.providers.catalog", "DEFAULT_PROVIDER_ID"),
    "PROVIDER_LABELS": ("codey.providers.catalog", "PROVIDER_LABELS"),
    ...
    "provider_ids": ("codey.providers.catalog", "provider_ids"),
