...
def _quality_review_followup(
    ...
    *,
    ...
    prompt = (
        ...
        "- If the review names an unopened URL and no currently allowed open action can open it, "
        "remove that URL, its source row, and any claim that depends on it before calling done.\n\n"
